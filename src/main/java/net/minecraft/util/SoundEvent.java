...
public class SoundEvent extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<SoundEvent> {
    ...
    public SoundEvent(ResourceLocation minecraftkey) {
        this.field_187506_b = minecraftkey;
    }
    ...
    private static void func_187502_a(String s) {
        ResourceLocation minecraftkey = new ResourceLocation(s);

        SoundEvent.field_187505_a.func_177775_a(SoundEvent.field_187507_c++, minecraftkey, new SoundEvent(minecraftkey));
    }
}
