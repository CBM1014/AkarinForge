...
public class AdvancementRewards {
    ...
    public void func_192113_a(final EntityPlayerMP entityplayer) {
        ...
        LootContext loottableinfo = (new LootContext.Builder(entityplayer.func_71121_q())).func_186472_a((Entity) entityplayer).func_186470_a(entityplayer).func_186469_a(entityplayer.func_184817_da()).func_186471_a(); // Forge: add player & luck to LootContext
