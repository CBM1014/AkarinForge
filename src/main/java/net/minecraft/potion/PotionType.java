...
public class PotionType extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<PotionType> {
    ...
    @Nullable
    public static PotionType func_185168_a(String s) {
        return (PotionType) PotionType.field_185176_a.func_82594_a(new ResourceLocation(s));
    }
    ...
    public PotionType(@Nullable String s, PotionEffect... amobeffect) {
        this.field_185179_d = s;
        this.field_185180_e = ImmutableList.copyOf(amobeffect);
    }

    public String func_185174_b(String s) {
        return this.field_185179_d == null ? s + ((ResourceLocation) PotionType.field_185176_a.func_177774_c(this)).func_110623_a() : s + this.field_185179_d;
    }
    ...
    public static void func_185175_b() {
        ...
        PotionType.field_185176_a.func_177776_a();
    }

    protected static void func_185173_a(String s, PotionType potionregistry) {
        PotionType.field_185176_a.func_177775_a(PotionType.field_185178_c++, new ResourceLocation(s), potionregistry);
    }
