...
public class BlockPistonStructureHelper {
    ...
    public boolean func_177253_a() {
        ...
        if (!BlockPistonBase.func_185646_a(iblockdata, this.field_177261_a, this.field_177260_c, this.field_177257_d, false, this.field_177257_d)) {
            ...
            for (int i = 0; i < this.field_177258_e.size(); ++i) {
                ...
                if (this.field_177261_a.func_180495_p(blockposition).func_177230_c().isStickyBlock(this.field_177261_a.func_180495_p(blockposition)) && !this.func_177250_b(blockposition)) {
                    return false;
                }
            }
    ...
    private boolean func_177251_a(BlockPos blockposition, EnumFacing enumdirection) {
        ...
        if (block.isAir(iblockdata, this.field_177261_a, blockposition)) {
            return true;
            ...
            if (i + this.field_177258_e.size() > 12) {
                ...
                while (block.isStickyBlock(iblockdata)) {
                    ...
                    if (iblockdata.func_177230_c().isAir(iblockdata, this.field_177261_a, blockposition1) || !BlockPistonBase.func_185646_a(iblockdata, this.field_177261_a, blockposition1, this.field_177257_d, false, this.field_177257_d.func_176734_d()) || blockposition1.equals(this.field_177259_b)) {
                        break;
                    }
                ...
                while (true) {
                    ...
                    if (l > -1) {
                        ...
                        for (int i1 = 0; i1 <= l + j; ++i1) {
                            ...
                            if (this.field_177261_a.func_180495_p(blockposition3).func_177230_c().isStickyBlock(this.field_177261_a.func_180495_p(blockposition3)) && !this.func_177250_b(blockposition3)) {
                                return false;
                            }
                        }
                    ...
                    if (iblockdata.func_177230_c().isAir(iblockdata, this.field_177261_a, blockposition2)) {
                        return true;
                    }
